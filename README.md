...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/openpisco-split-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openpisco-split-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add openpisco openpisco-core
# for installing globally
pixi global install openpisco openpisco-core
```
...
It is possible to list all of the versions of `openpisco` available on your platform:
...
```
pixi search openpisco --channel conda-forge
```
